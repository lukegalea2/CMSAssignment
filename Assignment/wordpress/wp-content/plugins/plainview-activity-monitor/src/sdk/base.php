...
class base
{
	...
	**/
	...
	{
		if ( ! class_exists( '\\plainview\\sdk_pvam\\form2\\form' ) )
			require_once( dirname( __FILE__ ) . '/form2/form.php' );

		if ( ! class_exists( '\\plainview\\sdk_pvam\\wordpress\\form2\\form' ) )
			require_once( 'form2.php' );

		$form = new \plainview\sdk_pvam\wordpress\form2\form();
		return $form;
	}
	...
	**/
	...
	/**
		...
		@return		\\plainview\\sdk_pvam\\mail\\mail		A new PHPmailer object.
		@since		20130430
	**/
