<?php
namespace plainview\sdk_pvam\wordpress;
...
**/
class base
	extends \plainview\sdk_pvam\base
{
	...
	**/
	public function __construct( $__FILE__ = null )
	{
		...
		$this->submenu_pages = new \plainview\sdk_pvam\collections\collection;
	...
	**/
	...
	{
		$form = new \plainview\sdk_pvam\wordpress\form2\form( $this );
		return $form;
	}

	/**
		@brief		Backwards compatibility alias for form.
		@return		\\plainview\\sdk_pvam\\form2\\form		A new form object.
		@since		20130509
	**/
	...
	**/
	...
	{
		$tabs = new \plainview\sdk_pvam\wordpress\tabs\Nav_Tabs( $this );
		return $tabs;
	}
	...
	**/
	...
	{
		$tabs = new \plainview\sdk_pvam\wordpress\tabs\Subsubsub_Tabs( $this );
		return $tabs;
	}
	...
	**/
	...
	/**
		...
		@return		object		A new \\plainview\\sdk_pvam\\wordpress\\table object.
		@since		20130416
	**/
	public function table()
	{
		$table = new \plainview\sdk_pvam\wordpress\table\table( $this );
