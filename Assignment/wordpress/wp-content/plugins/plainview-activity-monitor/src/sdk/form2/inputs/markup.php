...
namespace plainview\sdk_pvam\form2\inputs;
	...
	extends input
{
	...
	**/
	public function _construct()
	{
		if ( $this->get_attribute( 'name' ) == '' )
			$this->set_attribute( 'name', \plainview\sdk_pvam\base::uuid( 4 ) );
	}

	public function __toString()
	{
		return \plainview\sdk_pvam\form2\form::unfilter_text( $this->get_value() );
	}
	...
	**/
	public function p( $text )
	{
		...
		if ( $result == '' )
			$result = $text;
		return $this->markup( \plainview\sdk_pvam\base::wpautop( $result ) );
	}
