...
function vw_dentist_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-dentist' ) .'</h3>';
...
function vw_dentist_scripts() {
	...
	wp_enqueue_script( 'vw-dentist-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
function vw_dentist_ie_stylesheet(){
	wp_enqueue_style('vw-dentist-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-dentist-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_dentist_ie_stylesheet');
...
define('VW_DENTIST_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-dentist/','vw-dentist');
define('VW_DENTIST_SUPPORT','https://wordpress.org/support/theme/vw-dentist/','vw-dentist');
define('VW_DENTIST_REVIEW','https://wordpress.org/support/theme/vw-dentist/reviews','vw-dentist');
define('VW_DENTIST_BUY_NOW','https://www.vwthemes.com/themes/dentist-wordpress-theme/','vw-dentist');
define('VW_DENTIST_LIVE_DEMO','https://www.vwthemes.net/vw-dentist-pro/','vw-dentist');
define('VW_DENTIST_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-dentist-pro/','vw-dentist');
define('VW_DENTIST_FAQ','https://www.vwthemes.com/faqs/','vw-dentist');
define('VW_DENTIST_CONTACT','https://www.vwthemes.com/contact/','vw-dentist');
define('VW_DENTIST_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-dentist');
